...
export function useAutoFontSize(text: string | number, maxFontSize: number = 24, minFontSize: number = 8) {
  ...
  const updateFontSize = useCallback(() => {
    ...
    tempElement.textContent = typeof text === 'number' ? Intl.NumberFormat().format(text) : text
