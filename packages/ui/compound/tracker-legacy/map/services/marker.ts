...
class TooltipManager {
  ...
  public showTooltip(element: HTMLElement, getHtml: () => string, positionFn: (el: HTMLElement, tooltip: HTMLDivElement) => void): void {
...
export class MarkerManager {
   ...
   */
  public createCircleMarkerElement(event: Event, isActive: boolean): HTMLDivElement {
   ...
   */
  private positionTooltip(el: HTMLElement, tooltipDiv: HTMLDivElement | null): void {
