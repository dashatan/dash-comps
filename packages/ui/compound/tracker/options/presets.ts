...
> = {
  ...
  full: {
    ...
    geo: {
      filterIran: true,
      emphasize: { enabled: true, mapCircles: true, timelineBands: true },
    },
    markers: {
      headStyle: "arrow",
      perEventMarkers: true,
  ...
  minimal: {
    ...
    map: {
      engine: "maplibre",
      controls: { zoom: false, compass: false, fullscreen: false },
    },
