...
import {
  createDataSlice,
  type DataSlice,
} from "@dash/ui/compound/tracker/store/slices/data.slice";
import {
  createPlaybackSlice,
  type PlaybackSlice,
} from "@dash/ui/compound/tracker/store/slices/playback.slice";
import {
  createSettingsSlice,
  type SettingsSlice,
} from "@dash/ui/compound/tracker/store/slices/settings.slice";
import {
  createMapSlice,
  type MapSlice,
} from "@dash/ui/compound/tracker/store/slices/map.slice";
import {
  createUiSlice,
  type UiSlice,
} from "@dash/ui/compound/tracker/store/slices/ui.slice";
