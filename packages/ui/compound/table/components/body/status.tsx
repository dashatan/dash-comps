...
const statusBoxVariants = cva('relative flex h-8 min-w-28 items-center justify-center rounded-md border px-2 text-center  font-medium whitespace-nowrap', {
  variants: {
    color: {
...
export default function StatusBox({ text, className, color, icon, onClick, textClassName, justify = 'center', rounded = 'full' }: StatusBoxProps) {
  return (
    <div
