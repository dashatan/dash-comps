...
import { resolveTrackerOptions } from "@dash/ui/compound/tracker-new/options/resolve-options";
import {
  createTrackerStore,
  type TrackerStoreApi,
} from "@dash/ui/compound/tracker-new/store/create-store";
import { TrackerStoreProvider } from "@dash/ui/compound/tracker-new/store/context";
import { useTrackerStore } from "@dash/ui/compound/tracker-new/store/hooks";
import {
  detectInputKind,
  adaptTracksInput,
  mergeTracksIntoNormalized,
} from "@dash/ui/compound/tracker-new/adapters/from-tracks";
import { adaptEventsInput } from "@dash/ui/compound/tracker-new/adapters/from-events";
import { processTracksData } from "@dash/ui/compound/tracker-new/data/remap";
import type { RemapWorkerOutput } from "@dash/ui/compound/tracker-new/data/remap.worker";
import {
  resolveOsrmRouteCoords,
  resolveDirectRouteCoords,
} from "@dash/ui/compound/tracker-new/map/route/strategies";
import { mapEventsToOsrmIndices } from "@dash/ui/compound/tracker-new/utils/geo";
import { makeTimes } from "@dash/ui/compound/tracker-new/data/remap";
        ...
        if (kind === "tracks" && input.kind === "tracks") {
          ...
          if (resolvedOptions.data.useWorker && typeof Worker !== "undefined") {
            ...
            workerRef.current = new Worker(
              new URL(
                "@dash/ui/compound/tracker-new/data/remap.worker.ts",
                import.meta.url,
              ),
              { type: "module" },
            );
