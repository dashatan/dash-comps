import type { EventsInput, ObserveEvent } from "@/components/compound/tracker-new/types/input";
import type { NormalizedEvent, NormalizedTrackerData } from "@/components/compound/tracker-new/types/normalized";
import { makeTotalTimesIncludingEvents } from "@/components/compound/tracker-new/data/remap";
import { createTimeline } from "@/components/compound/tracker-new/data/remap";
import { totalTimeLineDaysWithEventIndexes } from "@/components/compound/tracker-new/data/remap";
