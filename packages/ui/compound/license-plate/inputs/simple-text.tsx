...
/* ------------------------------ Main Function ----------------------------- */
const SimpleText = forwardRef<HTMLInputElement, Props>(
  ({ inputProps, onChange, id, ...props }: Props, ref) => {
    ...
    return (
      <div className="w-full">
        <input
          ...
          value={value || ""}
          className={cn(
            "!m-0 h-full w-full !p-0 text-center !text-2xl font-extrabold focus-visible:outline-none",
            props.className,
          )}
          onKeyDown={(e) => {
