...
/* ------------------------------ Main Function ----------------------------- */
export default function ProtocolPlate({
  onChange,
  ...props
}: ProtocolPlateInputProps) {
  const ref1 = useRef<HTMLInputElement>(null);
  const [values, setValues] = useState<ProtocolPlateInputValue>(
    normalizeFrom(props.values || {}),
  );
  ...
  return (
    ...
    >
      <div className="flex h-full w-[38px] min-w-[38px] flex-col items-center justify-center gap-1">
        ...
        <div className="flex flex-col text-[9px] font-bold dir-ltr">
          <span>I.R.</span>
      ...
      <div className="flex h-full w-full">
        <Number
          ...
          ref={ref1}
          className={cn(
            "text-plate-protocol-text",
            "selection:bg-plate-protocol-light",
          )}
