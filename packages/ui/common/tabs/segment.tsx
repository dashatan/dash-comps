...
export default function Segments(props: Props) {
  ...
  return (
    <div className={cn('border-border flex h-14 w-full items-center overflow-hidden rounded-lg border transition-all', props.className?.container)}>
        ...
        return (
          <div
            ...
            className={cn(
              ...
              'text-foreground justify-center text-xs font-medium text-nowrap transition-all',
              {
          ...
          >
            {!props.withoutIndicator && (
              <Circle
                className={cn('fill-foreground absolute right-1 ms-1 w-2 opacity-0 transition-all', {
