...
export type DoughnutChartProps<D extends readonly DoughnutDataItem[] = readonly DoughnutDataItem[]> =
...
function DoughnutChartRender<const D extends readonly DoughnutDataItem[]>(
  ...
  ref: Ref<EChartsReact>,
    ...
    }, [data, title, labelFontSize, labelPosition, radius, roseType, showLegend, colors, borderWidth, borderColor, borderRadius])

    return (
      <BaseChart<InferChartPayloadFromData<D>> ref={ref} options={options} {...props} />
    )
  }
