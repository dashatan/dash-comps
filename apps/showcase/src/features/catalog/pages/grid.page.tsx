...
export function GridPage() {
  ...
  return (
    <CatalogPageShell slug="grid">
      <ShowcaseSection title={p("threeColumns.title")} className="w-full">
      ...
      <ShowcaseSection
        title={p("responsiveSpans.title")}
        delay={0.05}
        className="w-full"
      >
        <GridContainer className="grid w-full max-w-lg grid-cols-4 gap-2">
          <div className="bg-primary/20 col-span-2 rounded-md p-3 text-sm">
            {p("responsiveSpans.span2")}
          </div>
