...
const commonCatalogCategories: CatalogCategory[] = [
  ...
  { slug: "cards", icon: CreditCard, count: 11 },
  { slug: "carousel", icon: GalleryHorizontal, count: 11 },
  ...
  { slug: "fadeable", icon: Eye, count: 8 },
  ...
  { slug: "loading", icon: Loader2, count: 9 },
  { slug: "map", icon: Map, count: 12 },
  { slug: "overlay", icon: PanelTop, count: 16 },
  { slug: "pagination", icon: ChevronsLeftRight, count: 9 },
  { slug: "shapes", icon: Shapes, count: 8 },
  { slug: "skeleton", icon: Bone, count: 15 },
  { slug: "slider", icon: SlidersHorizontal, count: 13 },
  { slug: "sonner", icon: BellRing, count: 4 },
  { slug: "steps", icon: ListOrdered, count: 11 },
  { slug: "tabs", icon: Layers, count: 13 },
  { slug: "timeline", icon: GitBranch, count: 8 },
...
const compoundCatalogCategories: CatalogCategory[] = [
  ...
  { slug: "file-uploader", icon: Upload, count: 10 },
...
export const catalogCategories: CatalogCategory[] =
  catalogCategoryGroups.flatMap(({ items }) => items);
